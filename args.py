...
exp_group.add_argument('--save', default='save/default-{}'.format(time.strftime('%m%d_%H:%M:%S')),
...
exp_group.add_argument('--pretrained', default=None, type=str, metavar='PATH',
...
arch_group.add_argument('--arch', '-a', metavar='ARCH', default='msnet', type=str)
...
arch_group.add_argument('--step', type=str, default='1-2-3-4-5-6-7')
...
optim_group.add_argument('--epochs', default=310, type=int, metavar='N',
                         help='number of total epochs to run (default: 310)')
...
optim_group.add_argument('--lr-type', default='SGDR', type=str, metavar='T',

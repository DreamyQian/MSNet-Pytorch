...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_loss, train_prec1, train_prec5, lr = train(train_loader, model, pred_model, criterion, optimizer, epoch, pad_reg)
...
def train(train_loader, model, pred_model, criterion, optimizer, epoch, pad_reg):
